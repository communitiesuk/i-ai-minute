...
Optimise FFmpeg processing without impacting transcription quality.
...
![alt text](../../documentation/assets/codec_by_wer.png)
...
![alt text](../../documentation/assets/codec_by_file_size.png)
![alt text](../../documentation/assets/codec_by_CPU_time.png)

Opus, MP4 and AAC have the smallest file sizes, but the highest CPU times.
...
- Sample is quite small - Minute meetings could be closer to 1 hour (vs ~5 minutes).
  ...
  - Looking at non-transcription metrics however, using longer files (~1 hour) shows very little change in CPU time per second and file size per second (linear scaling):
    ![alt text](../../documentation/assets/codec_by_file_size_long.png)
    ![alt text](../../documentation/assets/codec_by_CPU_time_long.png)
